...
class Checkout extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div>
          {alreadyOrdered ?
                <button className="pay-button" onClick={() => this.setState({alreadyOrdered: false})}>Thank you for your order!
                </button>  :
              <div>
                {addedToBasket ? null : <button
                        ...
                        className="add-button">Currently in
                      Cart</button>}
                    ...
                    <form onSubmit={(e) => this.openStripe(e)}>
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-group col-md-4">
                          <input type="text" className="form-control"
                                 id="inputStreetNumber" placeholder="Number"
                                 name="streetNumber"
                                 onChange={this.handleInputChange}
                                 onBlur={this.handleInputChange}/>
                        </div>
